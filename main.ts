import { app, BrowserWindow, Tray, Menu, screen, Notification, dialog, remote } from 'electron';
...
autoUpdater.setFeedURL({ provider:'github', owner:'alexcollareda',repo:'electronupdater', token: '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' })
